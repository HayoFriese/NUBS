<?php
    ...
    echo pageIni("NUBS | Sign Up User", "forum.css", "signup.js");
    echo '<div id="content">';
	...
	if($_SERVER['REQUEST_METHOD'] != 'POST') {
		...
		echo '
                ...
                <div id="progress"></div>
                <div id="signIn">
                    <form id="signupUser" onsubmit="return false">
                        <h2 id="status">Create New Account</h2>
                        <div id="logIn">
                            <input type="text" id="userName" name="userName" placeholder="Username...">
                            <input type="password" id="passWord" name="passWord" placeholder="Password...">
                            <input type="password" id="passCheck" name="passCheck" placeholder="Confirm password...">
        
                            <button onclick="userSignUp()">Next &#187;</button>
                        </div>
                        ...
                        <div id="summary">
                           ...
                           <button onclick="userSummary()">Next &#187;</button>
                        </div>
                        ...
                        <div id="address">
                            ...
                            <button onclick="userAddress()">Next &#187;</button>
                        </div>
                        ...
                        <div id="confirm">
                            ...
                            <button onclick="userSubmitForm()">Submit Data</button>
                        </div>
                    </form>
                </div>
            </div>';
